...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        if self._is_actor:
            ...
            print(f"ppo_mini_batch_size {self.config.actor.ppo_mini_batch_size}, self.ulysses_sequence_parallel_size {self.ulysses_sequence_parallel_size}, self.device_mesh.size {self.device_mesh.size()}")
